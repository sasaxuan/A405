...
ax1.figure.savefig('alb_height.png',dpi=200)
...
ax1.figure.savefig('alb_press.png',dpi=200)
...
ax1.figure.savefig('alb_press_logy.png',dpi=200)
...
ax1.set_ylim([1.5,7])
ax1.set_xlim([-20,40])
ax1.set_title('July 2010 - 5am soundings')
ax1.set_xlabel('temperature (deg C)')
ax1.set_ylabel('height (km)')
ax1.figure.savefig('alb_height_5am.png',dpi=200)
...
ax1.set_ylim([1.5,7])
ax1.set_xlim([-20,40])
ax1.set_title('July 2010 - 5pm soundings')
ax1.set_xlabel('temperature (deg C)')
ax1.set_ylabel('height (km)')
ax1.figure.savefig('alb_height_5pm.png',dpi=200)
